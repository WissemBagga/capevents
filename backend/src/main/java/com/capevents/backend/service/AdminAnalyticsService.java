    ...
    import com.capevents.backend.repository.EventFeedbackRepository;
    ...
    public class AdminAnalyticsService {
        ...
        private List<Event> resolveScopedEvents(User actor) {
            ...
            boolean isManager = actor.getRoles().stream()
                    .anyMatch(r -> r.getCode().equals("ROLE_MANAGER"));
            ...
            return eventRepository.findAllForAnalyticsVisibleToDepartment(actor.getDepartment().getId());
        }

...
export const EVENT_IMAGE_PRESETS: EventImagePreset[] = [
  ...
  { category: 'ConfÃ©rence', label: 'ConfÃ©rence', url: '/images/events/conference.jpg' },
  ...
  { category: 'Bien-Ãªtre', label: 'Bien-Ãªtre', url: '/images/events/bien-etre.jpg' },
  ...
  { category: 'Culture dâ€™entreprise', label: 'Culture dâ€™entreprise', url: '/images/events/culture-dentreprise.jpg' },

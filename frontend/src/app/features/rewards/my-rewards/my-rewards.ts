...
export class MyRewards {
  ...
  getRewardIconSvg(title: string): string {
    ...
    // Coffee/Breakfast
    if (t.includes('café') || t.includes('petit-déjeuner') || t.includes('croissant') || t.includes('boisson') || t.includes('coffee') || t.includes('goûter')) {
    ...
    // Gift Card/Voucher
    if (t.includes('carte') || t.includes('bon') || t.includes('cadeau') || t.includes('chèque') || t.includes('gift') || t.includes('voucher') || t.includes('amazon') || t.includes('netflix')) {
    ...
    // Day off/Leave
    if (t.includes('journée') || t.includes('congé') || t.includes('repos') || t.includes('libre') || t.includes('off') || t.includes('vacances') || t.includes('midi') || t.includes('matinée')) {
    ...
    // Training/Books
    if (t.includes('formation') || t.includes('cours') || t.includes('livre') || t.includes('learning') || t.includes('book') || t.includes('certif') || t.includes('conférence')) {
  ...
  getRewardImageUrl(title: string): string {
    ...
    if (t.includes('café') || t.includes('petit') || t.includes('boisson') || t.includes('coffee') || t.includes('croissant')) {
    ...
    if (t.includes('télétravail') || t.includes('remote') || t.includes('maison') || t.includes('home') || t.includes('journée')) {
